 ...
 */
var j;
const N = window, m = N.trustedTypes, J = m ? m.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, v = `lit$${(Math.random() + "").slice(9)}$`, nt = "?" + v, ut = `<${nt}>`, y = document, w = (n = "") => y.createComment(n), C = (n) => n === null || typeof n != "object" && typeof n != "function", ot = Array.isArray, pt = (n) => ot(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, F = /-->/g, G = />/g, _ = RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
...
class x {
  ...
  k(t) {
    ...
    let i, s = 0;
    for (const o of t)
      s === e.length ? e.push(i = new x(this.O(w()), this.O(w()), this, this.options)) : i = e[s], i._$AI(o), s++;
...
b.finalized = !0, b._$litElement$ = !0, (L = globalThis.litElementHydrateSupport) === null || L === void 0 || L.call(globalThis, { LitElement: b });
...
var bt = Object.defineProperty, wt = Object.getOwnPropertyDescriptor, V = (n, t, e, i) => {
