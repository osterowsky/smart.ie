        ...
        <div class="home-container">
            ...
            <section className="polityka-section">
                 ...
                 <p className="polityka-description">
                    <ul>
                            <li>
                                <p><strong>Serwis</strong> - serwis internetowy "smart.ie" działający pod adresem https://smart.ie</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest osoba fizyczna "Patryk Ostern" zamieszkała w Wrocław, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p>
                            </li>
                            <li>
                ...
                <h2 className="polityka-heading">§2 Inspektor Ochrony Danych</h2>
                 <p className="polityka-description">
                 ...
                 <h2 className="polityka-heading">§3 Rodzaje Plików Cookies</h2>
                 <p className="polityka-description">
                 <ul>
                        <li>
                 ...
                 <h2 className="polityka-heading">§4 Bezpieczeństwo składowania danych</h2>
                 <p className="polityka-description">
                 <ul>
                    <li>
                 ...
                 <h2 className="polityka-heading">§5 Cele do których wykorzystywane są pliki Cookie</h2>
                 <p className="polityka-description">
                 <ul id="cele">
                 ...
                 <h2 className="polityka-heading">§6 Cele przetwarzania danych osobowych</h2>
                 <p className="polityka-description">
                            <p>Dane osobowe dobrowolnie podane przez Użytkowników są przetwarzane w jednym z następujących celów:</p>
                                        ...
                                        <h2 className="polityka-heading">§7 Pliki Cookies Serwisów zewnętrznych</h2>
                                        <p className="polityka-description">
                 ...
                 <h2 className="polityka-heading">§8 Rodzaje gromadzonych danych</h2>
                 <p className="polityka-description">
                 ...
                 <h2 className="polityka-heading">§9 Dostęp do danych osobowych przez podmioty trzecie</h2>
                 <p className="polityka-description">
                        ...
                        <p>Administrator w celu świadczenia usługi Newsletter, korzysta z usług podmiotu trzeciego - serwisu <strong><a rel="nofollow external" href="https://www.sendinblue.com/legal/privacypolicy/">SendInBlue</a>, </strong>. Dane wprowadzone w formularzu zapisu do newslettera są przekazywane, przechowywane i przetwarzane w serwisie zewnętrznym tego usługodawcy.</p>
                        ...
                        <p>Administrator w celu prowadzenia serwisu korzysta z usług zewnętrznego dostawcy hostingu, VPS lub Serwerów Dedykowanych - <strong><a rel="nofollow external" href="https://www.netlify.com/privacy/">NETLIFY</a></strong>. Wszelkie dane gromadzone i przetwarzane w serwisie są przechowywane i przetwarzane w infrastrukturze usługodawcy zlokalizowanej w Polsce. Istnieje możliwość dostępu do danych wskutek prac serwisowych realizowanych przez personel usługodawcy. Dostęp do tych danych reguluje umowa zawarta pomiędzy Administratorem a Usługodawcą.</p>
                        <br />
                 </p>
                 <h2 className="polityka-heading">§10 Sposób przetwarzania danych osobowych</h2>
                 <p className="polityka-description">
                 ...
                 <h2 className="polityka-heading">§11 Podstawy prawne przetwarzania danych osobowych</h2>
                 <p className="polityka-description">
                 ...
                 <h2 className="polityka-heading">§12 Okres przetwarzania danych osobowych</h2>
                 <p className="polityka-description">
                    <p><strong>Dane osobowe podane dobrowolnie przez Użytkowników:</strong></p>
                 ...
                 <h2 className="polityka-heading">§13 Prawa Użytkowników związane z przetwarzaniem danych osobowych</h2>
                 <p className="polityka-description">
                    <p>Serwis gromadzi i przetwarza dane Użytkowników na podstawie:</p>
                    <ul>
                        <li>
                 ...
                 <h2 className="polityka-heading">§14 Kontakt do Administratora</h2>
                 <p className="polityka-description">
                 <p>Z Administratorem można skontaktować się w jeden z poniższych sposobów</p>
                    <ul>
                        <li>
                            <p><strong>Adres poczty elektronicznej</strong> - ostern.patryk02@gmail.com</p>
                        </li>
                        <li>
                            <p><strong>Połączenie telefoniczne</strong> - +48 797 507 138</p>
                        </li>
                        <li>
                 ...
                 <h2 className="polityka-heading">§15 Wymagania Serwisu</h2>
                 <p className="polityka-description">
                 <ul>
                    <li>
                 ...
                 <h2 className="polityka-heading">§16 Linki zewnętrzne</h2>
                <p className="polityka-description">
                 ...
                 <h2 className="polityka-heading">§17 Zmiany w Polityce Prywatności</h2>
                 <p className="polityka-description">
                    <ul>
                        <li>
